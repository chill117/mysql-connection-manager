...
MySQLConnectionManager.prototype.reconnect = function() {
	...
	this.connect(bind(function(error) {
...
MySQLConnectionManager.prototype.listenForDisconnect = function() {
	...
	this.connection.on('error', bind(function(error) {
...
MySQLConnectionManager.prototype.setKeepAliveInterval = function(interval) {
	...
	this._keepAliveInterval = setInterval(bind(function() {

		this.keepAlive(bind(function(error) {
	...
	}, this), interval || this.options.keepAliveInterval);
};
